...
app.get("/", (req, res) => {
  res.sendFile(path.join(__dirname, "../frontend/src", "index.js")); // Send the HTML file in the response
});
...
// Get all responses (used for fetching initial data in the React app)
